                ...
                if (!contentArea.hasClass('active')) {
                    ...
                    var configuration = $.extend(
                        (settings.ckeditor && settings.ckeditor.config ? settings.ckeditor.config : {}), 
                        {
                            ...
                            contentsCss: ["http://localhost/wysiwyggrid/bower_components/bootstrap/dist/css/bootstrap.min.css"]
                        }
                    );
                    var instance = CKEDITOR.replace(contentArea.get(0), configuration);
                }
            });
        },
